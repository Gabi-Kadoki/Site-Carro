...
const contentData = {
    ...
    transmissao: {
      ...
      additional: {
        embreagem: {
          text: "Em carros com transmissão manual, a embreagem é um componente essencial para desacoplar o motor da transmissão, permitindo que o motorista troque as marchas sem danificar o sistema. Para mais detalhes, consulte o setor responsável pelo sistema de embreagem.",
          image: "../img/pecas/transmissao/embreagem.png"
        },
        caixaMarchas: {
          text: "A parte central da transmissão, onde as engrenagens que controlam as diferentes marchas estão localizadas. Em transmissões manuais, o motorista seleciona as marchas manualmente. Em automáticas, o sistema controla as trocas.",
          image: "../img/pecas/transmissao/caixaMarchas.png"
        },
        diferencial: {
          text: "O diferencial permite que as rodas do carro girem a velocidades diferentes. Ele distribui a potência do motor para as rodas de maneira que as duas possam girar de forma independente. Ou seja, uma roda pode girar mais rápido que a outra quando o carro está fazendo curvas, sem causar danos ao sistema de transmissão.",
    ...
    embreagem: {
      ...
      additional: {
        ...
        plato: {
          text: "É responsável por pressionar o disco de embreagem contra o volante do motor. Sua função é garantir que a conexão entre o motor e a transmissão seja firmemente estabelecida quando o pedal não está pressionado.",
    ...
    suspensao: {
      ...
      additional: {
        amortecedores: {
          text: "Os amortecedores ajudam a controlar o movimento das molas e reduzem os impactos e a vibração que são transmitidos para o carro. Eles trabalham em conjunto com as molas para controlar o movimento das rodas.",
          image: "../img/pecas/sistema-suspensao/amortecedores.png"
        },
        molas: {
          text: "As molas são responsáveis por suportar o peso do carro e absorver os impactos da estrada. Elas podem ser do tipo helicoidal (mais comuns), a lâmina (molas retas) ou outros tipos, dependendo do design do veículo.",
    ...
    freios: {
      ...
      additional: {
        pastilhas: {
          text: "São as peças que pressionam contra os discos de freio (no sistema de freio a disco) para reduzir a velocidade do veículo. Em sistemas de freio a tambor, são chamadas de sapatas de freio.",
        ...
        cilindroRoda: {
          text: "Nos sistemas de freio a tambor, os cilindros de roda são responsáveis por empurrar as sapatas de freio contra o tambor. Em carros com freios a disco, o cilindro de roda é substituído pelas pinças.",
          image: "../img/pecas/sistema-freio/cilindroRoda.png"
        },
        fluido: {
          text: "O fluido hidráulico transmite a pressão do cilindro mestre para as outras partes do sistema de freio, permitindo que as pastilhas ou sapatas exerçam pressão nas superfícies de frenagem.",
          image: "../img/pecas/sistema-freio/fluido.png"
        },
        absorvedor: {
          text: "Nos sistemas de freios a disco, os pistões são movidos pela pressão do fluido para acionar as pinças de freio. Eles também ajudam a controlar a força aplicada nas pastilhas de freio.",
    ...
    direcao: {
      ...
      additional: {
        volanteDirecao: {
          text: "O volante é o componente que o motorista usa para controlar a direção do veículo. Ele está conectado ao sistema de direção e permite que o motorista faça curvas e altere a trajetória do carro.",
          image: "../img/pecas/sistema-direcao/volanteDirecao.png"
        },
        colunaDirecao: {
          text: "A coluna de direção conecta o volante ao mecanismo de direção (geralmente o pinhão e a cremalheira ou a caixa de direção). Ela transmite o movimento do volante para o sistema de direção.",
          image: "../img/pecas/sistema-direcao/colunaDirecao.png"
        },
        caixaDirecao: {
          text: "A caixa de direção é o componente que converte o movimento rotacional do volante em movimento linear, ajudando a mover as rodas do veículo. Pode ser do tipo caixa de direção de pinhão e cremalheira (mais comum) ou do tipo caixa de direção de setor e braçadeiras.",
        ...
        terminaisDirecao: {
          text: "Localizados nas extremidades das barras de direção, os terminais de direção conectam as barras às rodas, permitindo que o movimento da direção seja transferido para as rodas de forma eficiente.",
    ...
    arrefecimento: {
      ...
      additional: {
        radiador: {
          text: "O radiador é o componente que dissipa o calor do fluido de arrefecimento. Ele é responsável por resfriar o fluido de arrefecimento quente, enviando-o de volta ao motor para continuar o ciclo de arrefecimento.",
          image: "../img/pecas/sistema-arrefecimento/radiador.png"
        },
        bombadagua: {
          text: "A bomba d'água é responsável por circular o fluido de arrefecimento através do motor e do radiador. Ela mantém o fluido em movimento, ajudando a transferir o calor do motor para o radiador.",
          image: "../img/pecas/sistema-arrefecimento/bombaDagua.png"
            ...
            ventoinha: {
                text: "A ventoinha ajuda a reduzir a temperatura do fluido de arrefecimento no radiador, especialmente quando o carro está parado ou em baixa velocidade. Ela é ativada automaticamente quando a temperatura do motor sobe demais.",
                image: "../img/pecas/sistema-arrefecimento/ventoinhas.png"
            },
            reservatorio: {
                text: "É o local onde o fluido de arrefecimento excedente é armazenado quando o sistema de arrefecimento esquenta. Ele permite que o fluido se expanda e se contraia à medida que a temperatura muda, sem causar vazamentos ou danos ao sistema.",
                image: "../img/pecas/sistema-arrefecimento/reservatorioExpansao.png"
            },
            fluidoArrefecimento: {
                text: "O fluido de arrefecimento, também conhecido como anticongelante, circula pelo sistema para absorver o calor do motor e transferi-lo para o radiador. Ele também ajuda a prevenir o congelamento do motor em temperaturas baixas e evita a corrosão dos componentes do sistema de arrefecimento.",
    ...
    eletrico: {
        ...
        additional: {
            bateria: {
                text: "A bateria armazena a energia elétrica e fornece a energia necessária para iniciar o motor, além de alimentar os componentes elétricos quando o motor está desligado. Ela é responsável por fornecer a energia para a partida e para sistemas como luzes, rádio, etc.",
                image: "../img/pecas/sistema-eletrico/bateria.png"
            },
            alternadorEletrico: {
                text: "O alternador é um gerador de eletricidade que carrega a bateria enquanto o motor está funcionando e alimenta os sistemas elétricos do carro (como luzes e sistemas de infotainment). Ele converte a energia mecânica do motor em energia elétrica.",
            ...
            fusiveis: {
                text: "Os fusíveis protegem os circuitos elétricos de sobrecarga ou curto-circuito, interrompendo o fluxo de eletricidade quando necessário. Relés são interruptores elétricos que controlam o fluxo de corrente para componentes específicos, como faróis ou bombas de combustível.",
            ...
            cabos: {
                text: "Os cabos e fios conectam todos os componentes elétricos entre si, transmitindo a corrente elétrica entre a bateria, alternador, motor de arranque, sensores, atuadores e outros sistemas.",
            ...
            sensores: {
                text: "Sensores monitoram as condições do veículo e transmitem essas informações para o sistema de controle eletrônico, como a ECU (Unidade de Controle do Motor). Atuadores, por sua vez, executam ações com base nessas informações, como ajustar o combustível ou controlar sistemas de emissões.",
                image: "../img/pecas/sistema-eletrico/sensores.png"
            },
            ecu: {
                text: "A ECU é o \"cérebro\" do sistema eletrônico do carro, controlando uma variedade de sistemas, incluindo o motor, os freios (em sistemas ABS), a transmissão, e sistemas de segurança. Ela recebe dados dos sensores e ajusta o funcionamento de vários componentes do veículo.",
                image: "../img/pecas/sistema-eletrico/ECU.png"
            },
            luzes: {
                text: "O sistema elétrico também alimenta as luzes internas e externas do veículo, como faróis, lanternas, luzes de freio, indicadores de direção, e luzes internas, garantindo a visibilidade e segurança.",
